...
Software engineer with hands-on experience building full-stack web applications using **React**, **JavaScript**, **Node.js**, and **MySQL**. Passionate about crafting clean, user-centric interfaces and developing scalable backend systems. Known for a creative and collaborative approach, with a strong focus on writing maintainable code. Enthusiastic and team-oriented, yet enjoys the challenge of self-directed tasks when working independently. Always learning and eager to contribute to impactful, real-world projects.

Currently seeking opportunities to grow as a developer and build meaningful software.
